  ...
  return (
    <div className='relative '>
        ...
        <div className='flex items-center mt-6 font-medium'>
            <Link to={"/products"} className='bg-primary hover:bg-primary-dull group flex items-center gap-2 px-7 md:px-9 py-3 transition rounded text-white cursor-pointer'>Shop Now
